...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "format-all" '("fantomas" "fish-indent" "fprettify" "zig" "zprint" "yapf" "v-fmt" "taplo-fmt" "terraform-fmt" "ts-standard" "scalafmt" "shfmt" "snakefmt" "sqlformat" "swiftformat" "raco-fmt" "rescript" "perltidy" "pgformatter" "prettier" "pur" "ocp-indent" "ormolu" "nginxfmt" "nix" "mix-format" "latexindent" "ledger-mode" "lua-fmt" "ktlint" "jsonnetfmt" "isort" "istyle-verilog" "hindent" "html-tidy" "gawk" "gleam" "efmt" "elm-format" "emacs-" "erb-format" "define-format-all-formatter" "dart" "dfmt" "dhall" "dockfmt" "cabal-fmt" "cmake-format" "crystal" "beautysh" "black" "brittany" "bsrefmt" "buildifier" "alejandra" "atsfmt" "auctex")))
